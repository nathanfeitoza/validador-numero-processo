...
export default class ValidadorNumeroProcesso {
   ...
   */
  private static formatarNumero = (numero: number | string): string => (
    `${numero}`.padStart(7, '0')
  );
   ...
   */
  private static formatarAno = (ano: number | string): string => (
    `${ano}`.padStart(4, '0')
  );
   ...
   */
  private static formatarVara = (vara: number | string): string => (
    `${vara}`.padStart(4, '0')
  );
   ...
   */
  private static formatarOrgaoTribunal = (orgaoTribunal: number | string): string => (
    `${orgaoTribunal}`.padStart(3, '0')
  );
   ...
   */
  private static formatarDigitoVerificador = (digitoVerificador: number | string): string => (
  ...
  private static calcular(processo: string): string | never {
